      ...
      <div className="w-full flex justify-between items-center px-[15px] py-4">
        <div className="flex sm:gap-[20px] gap-[15px] items-center">
          <Button
            ...
            className="w-8.5 h-8.5 rounded-lg border border-gray-300 justify-center items-center flex lg:hidden"
          >
            <Menu size={18} />
          </Button>
          ...
          <Button
            ...
            className="w-8.5 h-8.5 hover-scale rounded-lg border border-gray-300 justify-center items-center flex relative"
          >
            <Maximize size={18} />
          </Button>
        </div>
